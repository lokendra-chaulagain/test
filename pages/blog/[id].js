...
const create = () => {
  const [obj, setObj] = useState({ title: '',authorName:"", Description: '', thumbnail: '',date:'',  status: 1,metatitle:'',metakeyword:'',metadescription:'' });
  ...
  const updateHandler = async () => {
   ...
   let res=await CallApi.updateData(`blog/update/${router.query.id}`, formData);
  //  console.log(res)
  ...
  let fetchData=async(id)=>{
   let data=await CallApi.EditData(`blog/edit/${id}`);
    setObj({ title: data.title,date:data.date, authorName:data.authorName,Description: data.Description,  thumbnail:  data.thumbnail,  status:data.status  });
  }
  ...
  return (
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="form-group mt-3 col-md-6">
                    ...
                    {obj.thumbnail&&   <Image src={`${process.env.NEXT_PUBLIC_CLOUDINARY_URL_SECURE}${obj.thumbnail}`} alt="" width="80" height={80} className="img-fluid custom-border-radius-50-per" unoptimized={true}/>
}
                  </div>
    ...
    <div className="form-group mt-3 col-md-6">
                    ...
                    <select id='status' name='status' className='form-control' onChange={(e) => setObj({ ...obj, status: e.target.value })} defaultValue={ obj.status}>
                  ...
                  <div className="form-group col-md-12 mt-3">
                    ...
                    <input  type="text" name="date" id="" cols="30" rows="4" className='form-control' onChange={(e) => setObj({ ...obj, date: e.target.value })}  value={obj.date} />
                  </div>
                  ...
                  <div className="form-group col-md-12 mt-3">
                    ...
                    <input type='text' name="metatitle" id="metatitle"  cols="30" rows="4" className='form-control' onChange={(e) => setObj({ ...obj, metatitle: e.target.value })} value={obj.metatitle} />
                  </div>


                  <div className="form-group col-md-12 mt-3">
                    <label className='mb-1' >Metakeyword</label>
                    <input type='text' name="metakeyword" id="metakeyword"  cols="30" rows="4" className='form-control' onChange={(e) => setObj({ ...obj, metakeyword: e.target.value })} value={obj.metakeyword} />
                  </div>


                  <div className="form-group col-md-12 mt-3">
                    <label className='mb-1' >MetaDescription</label>
                    <input type='text' name="metadescription" id="metadescription"  cols="30" rows="4" className='form-control' onChange={(e) => setObj({ ...obj, metadescription: e.target.value })} value={obj.metadescription} />
                  </div>
