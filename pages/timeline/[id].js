...
const create = () => {
  ...
  const updateHandler = async () => {
   ...
   let res=await CallApi.updateData(`timeline/update/${router.query.id}`, {...obj});
   console.log(res)
  ...
  let fetchData=async(id)=>{
   let data=await CallApi.EditData(`timeline/edit/${id}`);
              ...
              <div className="card-body">
                ...
                <div className="form-group">
                    ...
                    <input type="text"
                      ...
                      placeholder="Enter timeline Title" name='title' id='title' className='form-control' 
                  ...
                  <div className="form-group col-md-12 mt-3">
                    ...
                    {/* <textarea name="year" id="year"  cols="30" rows="4" className='form-control' 
                     ...
                     <input type="text"
                      placeholder="Enter timeline authorName" name='year' id='year' className='form-control' onChange={(e) => setObj({ ...obj, year: e.target.value })}  value={obj.year} />
