...
const create = () => {
  ...
  const addHandler = async () => {
    ...
    let res=await CallApi.storeData('timeline/create', {...obj});
    console.log(res)
                ...
                <div className="row">
                  ...
                  <div className="form-group">
                    ...
                    <input type="text"
                      ...
                      placeholder="Enter timeline Title" name='title' id='title' className='form-control' onChange={(e) => setObj({ ...obj, title: e.target.value })} />
                  ...
                  <div className="form-group col-md-12 mt-3">
                    ...
                    <input type="text"
                      placeholder="Enter timeline authorName" name='year' id='year' className='form-control' onChange={(e) => setObj({ ...obj, year: e.target.value })} />
                  </div>
